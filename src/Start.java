...
public class Start extends JFrame implements ActionListener{
    ...
    Start(String username){
        ...
        qno = new JLabel("");
        qno.setFont(boldFont);
        qno.setForeground(Color.WHITE);
        qno.setBounds(255, 170, 40, 30);
        add(qno);
        
        question = new JLabel("");
        question.setFont(boldFont);
        question.setForeground(Color.WHITE);
        question.setBounds(285, 170, 570, 30);
        add(question);
        ...
        opt1.setBounds(300, 220, 200, 30);
        opt1.setFont(boldFont);
        opt1.setForeground(Color.WHITE);
        opt1.setOpaque(false);
        add(opt1);
        
        opt2 = new JRadioButton("");
        opt2.setBounds(300, 260, 300, 30);
        opt2.setFont(boldFont);
        opt2.setForeground(Color.WHITE);
        opt2.setOpaque(false);
        add(opt2);
        
        opt3 = new JRadioButton("");
        opt3.setBounds(300, 300, 200, 30);
        opt3.setFont(boldFont);
        opt3.setForeground(Color.WHITE);
        opt3.setOpaque(false);
        add(opt3);
        
        opt4 = new JRadioButton("");
        opt4.setBounds(300, 340, 200, 30);
        opt4.setFont(boldFont);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == next){
            ...
            new End(username, score).setVisible(true);
        }
    }
    
    public void paint(Graphics g){
        super.paint(g);
        String time = "Time Remaining : " + timer; 
        g.setColor(Color.RED);
        g.setFont(new Font("Arista", Font.BOLD, 24));
        
        if(timer > 0) {
            g.drawString(time, 650, 180);
        }else {
